    ...
    <MainLayout>
      <div className="container">
        <Panel title="Copyright" wide transparent>
          ...
          <p>Návštěvníci i registrovaní uživatelé webu mají povolen přístup k materiálům na této stránce pouze pro osobní, nekomerční použití. Jakékoliv jiné použití, včetně kopírování, distribuce, reprodukce, úpravy, publikování nebo vytváření odvozených prací, je zakázáno bez předchozího písemného souhlasu.</p>
        </Panel>
      </div>
    </MainLayout>
  );
